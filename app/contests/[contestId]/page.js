...
const page = () => {
  ...
  const rankings = [
    { username: 'Suhaib King', score: 18, finish_time: '0:05:16' },
      ...
      <div className="flex gap-5 max-md:flex-col max-md:items-center">
        <div className="flex-grow">
          ...
          <ul>
            ...
            <li>To ensure the fairness of the contest, ProtCode will hide some
              test cases during the contest. When users submit incorrect
              submissions, ProCode will not show the hidden test cases to the
              users.</li>
